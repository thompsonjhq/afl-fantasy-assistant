...
function rowFromDb(row: Record<string, unknown>): PlayerGameLogRow {
  return {
    ...
    kicks: row.kicks != null ? Number(row.kicks) : undefined,
    handballs: row.handballs != null ? Number(row.handballs) : undefined,
    marks: row.marks != null ? Number(row.marks) : undefined,
    behinds: row.behinds != null ? Number(row.behinds) : undefined,
    tackles: row.tackles != null ? Number(row.tackles) : undefined,
    hitouts: row.hitouts != null ? Number(row.hitouts) : undefined,
    goalAssists: row.goal_assists != null ? Number(row.goal_assists) : undefined,
    inside50s: row.inside_50s != null ? Number(row.inside_50s) : undefined,
    clearances: row.clearances != null ? Number(row.clearances) : undefined,
    clangers: row.clangers != null ? Number(row.clangers) : undefined,
    rebound50s: row.rebound_50s != null ? Number(row.rebound_50s) : undefined,
    freesFor: row.frees_for != null ? Number(row.frees_for) : undefined,
    freesAgainst: row.frees_against != null ? Number(row.frees_against) : undefined,
